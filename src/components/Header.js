        ...
        <div className="container items-center ">
            <div className="items-center justify-between w-full px-5 overflow-y-auto tflex whitespace-nowrap scroll-hidden ">
                <div className="flex flex-col flex-wrap mx-auto md:items-center md:flex-row">
                    ...
                    {
                        verfiToken() && <div className="flex flex-row flex-1 items-center justify-end">
                            <button class="flex items-center px-6 py-2 m-2 text-blue-800 transition ease-in duration-200 uppercase rounded-full hover:bg-blue-700 hover:text-white border-2 border-blue-800 focus:outline-none" onClick={goToProfile}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Mon Profil
                            </button>
                            <button onClick={logOut} class="flex items-center px-6 m-2 py-2  text-blue-800 transition ease-in duration-200 uppercase rounded-full hover:bg-blue-700 hover:text-white border-2 border-blue-800 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
