                                    ...
                                    <div className="mt-5">
                                        <div className="flex flex-col justify-items-center items-center">
                                            ...
                                            <div className=" relative mb-2 ">
                                                <input type="email" name="email" value={userData.email} id="rounded-email" className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Email" onChange={onChangeText} />
                                            </div>
                                            <div className=" relative mb-2">
                                                <input type="text" name="name" value={userData.name} id="rounded-email" className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Nom & Prénom" onChange={onChangeText} />
                                            </div>

                                            <div className=" relative mb-2">
                                                <input type="password" name="password" value={userData.password} id="rounded-email" className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Mot de passe" onChange={onChangeText} />
                                            </div>
