...
const DetailsFromations = () => {
    ...
    return (
        <div className="w-full h-full container flex flex-col">
            <AddCourseDetails show={showModal}  close={handleClose} />
            <div className="flex flex-row w-full h-25 justify-start justify-items-center py-6">
                ...
                <div class="md:p-8 p-6 bg-white shadow-xl rounded-lg flex justify-between dark:bg-gray-800 md:items-center md:flex-row flex-col gap-12">
                    <div>
                        ...
                        }} class="block w-52 text-gray-700 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500" name="animals">
...
export default DetailsFromations
