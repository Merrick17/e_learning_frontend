                        ...
                        <div className="w-full px-8 py-24 bg-white rounded-lg border-blueGray-100 lg:w-8/12 lg:px-24 lg:py-4 lg:rounded-l-none s">
                            <div className="relative z-10 text-left ">
                                ...
                                <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
                                    <div>
                                        <label className="block text-base font-medium leading-relaxed text-blueGray-700">Nom & Prénom</label>
                                        <input type="text" name id placeholder="Nom & Prénom" className="w-full px-4 py-2 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-blueGray-100 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ext-black focus:border-blueGray-500" {...register("name", { required: true })} />
                                    </div>
                                    <div className="mt-4">
                                ...
                                <p className="mt-8 text-center">Vous avez déja un compte ? <Link to="/login" className="font-semibold text-black hover:text-black">Se connecter</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
